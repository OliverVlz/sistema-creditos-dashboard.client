...
import solicitaImage from "../../../../../assets_landing/images/landing/solicita.svg";
import calendarImage from "../../../../../assets_landing/images/landing/calendar1.svg";
import desembolsoImage from "../../../../../assets_landing/images/landing/desembolso.svg";
import mesadaImage from "../../../../../assets_landing/images/landing/mesada1.svg";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-base text-gray-700 mb-18 max-w-4xl mx-auto leading-relaxed">
            Si eres pensionado o activo de las Fuerzas Militares o la Policía
            Nacional, estás en el lugar correcto: gestionamos tu crédito por
            libranza con asesoría dedicada, cero costos ocultos y respuesta en
            menos de 24 horas. Aunque no tengas historial crediticio, puedes
            solicitar en línea 100 % seguro con total transparencia y
            acompañamiento.
          </p>
          ...
          <div className="grid max-w-5xl mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-18">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              />
              <p className="text-sm text-gray-700 font-medium">
                Proceso eficaz con desembolso ágil
              </p>
            </div>
