...
export default function RegisterForm() {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      const touchedState: Record<keyof RegisterFormData, boolean> =
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 max-w-lg mx-auto text-base md:text-lg">
                      Únete hoy y accede a nuestros servicios de crédito por
                      libranza de manera rápida y segura.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 lg:order-2 w-full max-w-3xl mx-auto bg-white/90 backdrop-blur-md rounded-3xl p-6 md:p-8 shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] border border-white/40">
                  ...
                  <EditText
                    ...
                    className={`w-full ${
                      errors.firstName && touched.firstName
                        ? "border-red-300 focus:border-red-500 ring-red-100"
                        : ""
                    }`}
                    disabled={isLoading}
              ...
              <div className="text-center mt-6">
                <p className="text-gray-500 text-sm">
                  ...
                  <Link
                    to="/login"
                    className="text-[#FF8546] font-bold hover:text-[#E64A2E] transition-colors ml-1"
                  >
                    Inicia sesión
                  </Link>
                </p>
