  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-50 via-white to-orange-50 dark:from-gray-800 dark:via-gray-850 dark:to-gray-900 border border-gray-100 dark:border-gray-700">
      ...
      <div className="relative z-10 p-8 text-center">
        ...
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-[#FF8546] to-[#ff6b2b] shadow-lg shadow-orange-500/25 mb-6 animate-bounce-slow">
          <PlusIcon className="w-10 h-10 text-white" />
        </div>

        {/* Título principal */}
        <div className="flex items-center justify-center gap-2 mb-3">
          <ShootingStarIcon className="w-5 h-5 text-[#FF8546]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {benefits.map((benefit, index) => (
            <div 
              key={benefit.title}
              className="flex flex-col items-center p-4 rounded-xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-md animate-fade-in-up"
              style={{ animationDelay: `${index * 150}ms` }}
            >
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#FF8546]/10 text-[#FF8546] mb-2">
                {benefit.icon}
              </div>
        ...
        <Link
          ...
          className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#FF8546] to-[#ff6b2b] hover:from-[#ff6b2b] hover:to-[#FF8546] text-white font-semibold rounded-xl shadow-lg shadow-orange-500/30 hover:shadow-orange-500/40 transition-all duration-300 hover:scale-105 group"
        >
          <span className="text-lg">Solicitar mi Primer Crédito</span>
        </Link>
