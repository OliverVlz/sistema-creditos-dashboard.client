...
import timeIcon from "../../assets_landing/images/decorative/time.svg";
...
export const InstitutionContent: React.FC<InstitutionContentProps> = ({
  ...
  const miniCards = [
    {
      ...
      title: "Hasta",
      value: "5'000.000",
      subtitle: "Monto máximo",
    },
    {
      icon: calendarIcon,
      title: "Plazo",
      value: "36 Meses",
      subtitle: "Hasta 36 meses",
    },
    {
      icon: timeIcon,
      title: "Respuesta",
  ...
  const documentsPensionado = [
    { number: "1.", title: "Cédula", description: "Ambos respaldos" },
    {
      ...
      description: "De mesada pensional",
    },
  ];
  ...
  const documentsActivo = [
    { number: "1.", title: "Cédula", description: "Ambos respaldos" },
    {
      number: "2.",
      title: "Comprobante de pago",
      description: "De nómina mensual",
    },
    {
      number: "3.",
      title: "Constancia de tiempo",
      description: "De servicio activo",
    },
  ];
      ...
      <section id="mini-cards" className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {miniCards.map((card, index) => (
            <div
              key={index}
              className="bg-[#f5f5f5ea] rounded-2xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300"
            >
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xl font-bold text-[#FF8546]">
                    {card.value}
                  </div>
                </div>
              </div>
            ...
            <div className="flex bg-gray-50 shadow-md rounded-xl p-2">
              ...
              >
                <img
                  ...
                  alt="Verified"
                  className={`w-5 h-5 ${
                    userType === "pensionado" ? "" : "filter brightness-0"
                  }`}
                />
                Pensionados
              </button>
            ...
            <div className="flex flex-col">
              <div>
                <h3 className="text-xl font-semibold text-global-12 mb-6">
                  <span className="underline decoration-[#FF8546] decoration-2 underline-offset-5">
                    Documentos necesarios
                  </span>
                </h3>
                <div className="space-y-4">
                  {currentDocuments.map((doc, idx) => (
                    <div key={idx} className="flex items-start gap-4">
                      <span className="text-[#FF8546] font-bold text-lg">
                        {doc.number}
                      </span>
                      <div>
                        <h4 className="font-semibold text-global-12">
                          {doc.title}
                        </h4>
                        <p className="text-global-6 text-sm">
                          {doc.description}
                        </p>
                      </div>
                    </div>
              ...
              <div className="mt-auto pt-8">
                <a
                  href="#"
                  className="text-global-6 text-sm block cursor-pointer"
                >
                  ¿Tienes dudas?{" "}
                  <span className="text-[#0076FF]">contáctanos ahora</span>
                </a>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  <h4 className="font-semibold text-global-12 mb-2">
                    ...
                    {userType === "pensionado" ? "mesada" : "nómina"}
                  </h4>
                  <ul className="text-sm text-global-6 space-y-1">
                    <li>
                      • Debe ser legible y no más antiguo de los últimos dos
                      meses
                    </li>
                    <li>• Debe ir en formato PDF</li>
                  </ul>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8 text-center">
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-global-12 mb-4">
                Desde
              </h3>
              <div className="text-4xl font-bold text-[#FF8546] mb-2">
                {rates.desde}
              </div>
              <div className="text-global-6">Mes vencido</div>
              <div className="text-sm text-global-6 mt-2">
                ({rates.desdeEA}% Efectiva Anual)
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-3 text-global-6">
              <p>
                • Tasas y plazos varían según el empleador y el perfil
                crediticio del cliente
              </p>
              <p>
                • Tasa máxima legal permitida para Junio 2025:{" "}
                <strong className="text-[#FF8546]">25.55% E.A</strong>
              </p>
              <p>
                •{" "}
                <span className="text-global-6">
                  Políticas de crédito disponibles{" "}
                </span>
                <a
                  href="#"
                  className="text-[#0076FF] hover:underline cursor-pointer"
                >
                  aquí
                </a>
              </p>
              <p className="text-sm text-gray-500">
                Fecha de actualización: Junio 5 de 2025
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative backdrop-blur-md bg-[#DEE5ED]/40 rounded-3xl p-8 md:p-12 shadow-md">
            ...
            <div className="relative">
              ...
              <p className="text-lg mb-8 text-global-7 max-w-2xl mx-auto">
                Como integrante de {institutionName}, tienes acceso a
                condiciones especiales para créditos por libranza con tasas
                preferenciales adaptadas a tu servicio.
              </p>
