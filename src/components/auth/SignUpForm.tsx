...
export default function SignUpForm() {
  ...
  return (
    <div className="flex flex-col flex-1 w-full overflow-y-auto lg:w-1/2 no-scrollbar px-4 sm:px-0">
      <div className="w-full max-w-md mx-auto mb-4 sm:mb-5 sm:pt-10">
        <Link
          to="/"
            ...
            <form>
              <div className="space-y-4 sm:space-y-5">
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  />
                  <p className="inline-block text-xs sm:text-sm font-normal text-gray-500 dark:text-gray-400">
                ...
                {/* <!-- Button --> */}
                <div>
                  <button className="flex items-center justify-center w-full px-4 py-2.5 sm:py-3 text-xs sm:text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                    Sign Up
                  </button>
                </div>
              </div>
